...
export { Menu, MenuItem, MenuSeparator, MenuLabel } from "./components/ui/menu";
...
export type { MenuProps, MenuItemProps, MenuSeparatorProps, MenuLabelProps } from "./components/ui/menu";
