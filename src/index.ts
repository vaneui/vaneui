...
export { Menu, MenuTrigger, MenuContent, MenuItem, MenuSeparator, MenuGroup, MenuLabel } from "./components/ui/menu";
...
export type { MenuProps, MenuItemProps, MenuTriggerProps, MenuContentProps, MenuSeparatorProps, MenuGroupProps, MenuLabelProps } from "./components/ui/menu";
