...
describe('Section Component Tests', () => {
  ...
  describe('TextAlign Props', () => {
    it('should apply textCenter class', () => {
      const {container} = render(
        <ThemeProvider theme={defaultTheme}>
          <Section textCenter>Centered section</Section>
        </ThemeProvider>
      );
