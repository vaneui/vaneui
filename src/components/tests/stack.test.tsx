...
describe('Stack Component Tests', () => {
  ...
  describe('Stack Component', () => {
    ...
    it('should support visual decoration props', () => {
      ...
      const stack = container.querySelector('div');
      expect(stack).toHaveClass(BORDER_WIDTH_CLASS);
      expect(stack).toHaveClass('border-(--border-color)');
      expect(stack).toHaveClass(RING_WIDTH_CLASS);
      expect(stack).toHaveClass('ring-(--ring-color)');
    ...
    it('should support appearance variants for background', () => {
      ...
      const stack = container.querySelector('div');
      expect(stack).toHaveClass('bg-(--bg-color)');
    });
    ...
    it('should support appearance variants for text color', () => {
      ...
      appearances.forEach(appearance => {
        ...
        const stack = container.querySelector('div');
        expect(stack).toHaveClass('text-(--text-color)');
      });
    });
    ...
    it('should support filled and outline variants for text, background, border, and ring', () => {
      ...
      // Text colors
      expect(outlineStack).toHaveClass('text-(--text-color)');
      expect(filledStack).toHaveClass('text-(--text-color)');
      
      // Background colors
      expect(outlineStack).toHaveClass('bg-(--bg-color)');
      expect(filledStack).toHaveClass('bg-(--bg-color)');
      
      // Border colors
      expect(outlineStack).toHaveClass('border-(--border-color)');
      expect(filledStack).toHaveClass('border-(--border-color)');
      
      // Ring colors
      expect(outlineStack).toHaveClass('ring-(--ring-color)');
