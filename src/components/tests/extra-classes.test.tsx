...
describe('Extra Classes Functionality Tests', () => {
  ...
  describe('Button Component Extra Classes', () => {
    ...
    it('should work without extra classes defined', () => {
      ...
      expect(button).toHaveClass('bg-(--color-bg-primary)'); // Should have normal theme classes
    });
  });
  ...
  describe('Edge Cases', () => {
    it('should handle empty extra classes object', () => {
      ...
      const button = container.querySelector('button');
      expect(button).toBeInTheDocument();
      expect(button).toHaveClass('bg-(--color-bg-primary)'); // Should still have theme classes
    });
