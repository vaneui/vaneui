...
export const POPUP_CATEGORIES = [...TYPOGRAPHY_FULL, ...LAYOUT_FULL, ...ALIGN_SELF, ...JUSTIFY_SELF, ...VISUAL_LAYOUT, ...PADDING, ...VARIANT, ...TRANSITION, ...WIDTH, ...HEIGHT, ...COMMON_MODIFIERS, ...PLACEMENT, ...POINTER_EVENTS, ...MIN_WIDTH, ...MAX_HEIGHT] as const;
