import { CommonAppearanceProps, FontFamilyProps, FontStyleProps, FontWeightProps, ItemsProps, TextAlignProps, TextAppearanceProps, TextDecorationProps, TextTransformProps } from "./props/props";
