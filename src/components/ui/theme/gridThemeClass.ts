 ...
 */
export class GridThemeClass extends BaseTheme {
  base: string;
  size: SizeTheme;
   ...
   */
  static createDefaultGridTheme(): GridThemeClass {
   ...
   */
  static createGrid3Theme(): GridThemeClass {
    const defaultTheme = GridThemeClass.createDefaultGridTheme();
    return new GridThemeClass(
   ...
   */
  static createGrid4Theme(): GridThemeClass {
    const defaultTheme = GridThemeClass.createDefaultGridTheme();
    return new GridThemeClass(
