...
export interface TagProps {
  tag?: React.ElementType | React.ForwardRefExoticComponent<any> | React.ComponentType<any> | React.JSXElementConstructor<any> | ((props: any) => React.ReactNode | Promise<React.ReactNode>) | string | any;
}
