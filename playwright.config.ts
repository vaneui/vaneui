...
// tailwind consumer) and the Tailwind-compiled dist/ui.css. rtl validates
// that the LOGICAL direction utilities the theme layer emits (ps-, border-s-,
// me-, text-start/end) are actually generated by each pipeline's source scan —
// a missing utility renders LTR-correct but silently breaks RTL.
//
...
const DUAL_PIPELINE_SPECS = /(css-noise-audit|computed-styles|filled-contrast|dark-mode|rtl)\.spec\.ts$/;
